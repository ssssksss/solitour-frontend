...
export const GatheringTimeModal = ({ closeModal }: GatheringTimeModalProps) => {
  ...
  return (
    <ModalTemplate
      className="max-h-88 w-[calc(100vw-1rem)] max-w-120"
    ...
    >
      <div className="flex min-h-full flex-col items-center justify-start bg-white">
        ...
        <div className="flex w-full flex-col items-center gap-x-5 max-[440px]:max-w-74.5">
          <div className="flex w-full justify-center gap-5 py-16.75 max-[440px]:flex-col max-[440px]:p-[2.875rem_0px_1.6875rem_0px]">
            {/* 날짜 */}
        ...
        <div className="flex w-full justify-center">
          <button
            className="bg-main disabled:bg-gray1 h-13.5 w-full max-w-74.5 shrink-0 rounded-[1.75rem] text-white"
