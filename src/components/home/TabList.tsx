...
const TabList = () => {
  return (
    <div className="flex w-full flex-row items-center justify-between gap-5 max-[744px]:flex-col">
      <Link
        className="flex h-72 flex-1 flex-col justify-between rounded-2xl bg-linear-to-br from-[#CBF6FF] to-[#EBE0FA] p-12 duration-300 hover:scale-105 max-[1024px]:h-48 max-[1024px]:p-6 max-[744px]:w-full"
      ...
      <Link
        className="flex h-72 flex-1 flex-col justify-between rounded-2xl bg-linear-to-br from-[#E7FCE0] to-[#C3E9FF] p-12 duration-300 hover:scale-105 max-[1024px]:h-48 max-[1024px]:p-6 max-[744px]:w-full"
        href="/gathering"
      >
        <div className="flex flex-col gap-2">
          <h2 className="text-2xl font-bold text-black max-[1024px]:text-lg">
