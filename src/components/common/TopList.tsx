      ...
      <div className="flex flex-row justify-between">
        <ol className="flex-grow space-y-6">
          <li className="flex flex-row">
            <p className="w-10 font-semibold">1.</p>
            <Link href="/">서촌 분위기 있는 혼술 카페 여기 있어!</Link>
          </li>
          <li className="flex flex-row">
            <p className="w-10 font-semibold">2.</p>
            <Link href="/">서촌 분위기 있는 혼술 카페 여기 있어!</Link>
          </li>
          <li className="flex flex-row">
            <p className="w-10 font-semibold">3.</p>
            <Link href="/">서촌 분위기 있는 혼술 카페 여기 있어!</Link>
          </li>
        </ol>
        <ol className="flex-grow space-y-6">
          <li className="flex flex-row">
            <p className="w-10 font-semibold">4.</p>
            <Link href="/">서촌 분위기 있는 혼술 카페 여기 있어!</Link>
          </li>
          <li className="flex flex-row">
            <p className="w-10 font-semibold">5.</p>
            <Link href="/">서촌 분위기 있는 혼술 카페 여기 있어!</Link>
          </li>
        </ol>
      </div>
