const InformationItemSkeleton = () => {
  return (
    <div className="flex h-[19.6875rem] w-full animate-pulse flex-col justify-between rounded-2xl bg-gray-100 outline outline-1 outline-gray3 duration-300 hover:outline-main">
