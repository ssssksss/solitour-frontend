...
const DiaryWriteButton = () => {
  return (
    <Link
      className="animate-cardFlip flex h-[38.9375rem] w-[29.375rem] flex-col items-center justify-center rounded-2xl border-[0.0625rem] border-gray3 bg-[#FBFBFB] hover:border-main dark:bg-slate-800 dark:hover:bg-slate-600"
      href="/diary/write"
    >
      <Image
