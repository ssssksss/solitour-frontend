  ...
  return (
    <div className={"flex items-center gap-x-[1.75rem]"}>
      <button
        ...
        className="flex h-[3.25rem] w-[17.5rem] overflow-hidden text-ellipsis whitespace-nowrap rounded-[3rem] px-[1rem] outline outline-[1px] outline-offset-[-1px] outline-[#E3E3E3]"
      >
