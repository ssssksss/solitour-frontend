      ...
      >
        {formContext.getValues("placeName") && (
          <a
            ...
            href={
              formContext.getValues("placeUrl") ||
              `http://map.kakao.com/link/map/${formContext.getValues("placeName")},${formContext.getValues("yAxis")},${formContext.getValues("xAxis")}`
            }
            target="_blanket"
          >
            <div
                ...
                <>
                  ...
                  <div className={"flex items-center gap-[1rem]"}>
                    <Image
                      ...
                      height={14}
                    />
                    <span> {formContext.getValues("roadAddressName")} </span>
                  </div>
                </>
              )}
            </div>
