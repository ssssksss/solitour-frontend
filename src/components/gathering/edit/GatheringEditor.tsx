...
import GatheringSchedule from "../write/GatheringSchedule";
  ...
  return (
    <div className={"flex w-full max-w-[60rem] flex-col"}>
      <div className="flex gap-[.25rem] text-[.625rem] text-gray2">
        ...
        <div> {">"} </div>
        <div className={"font-bold text-gray1"}> 모임 수정하기 </div>
      </div>
      <div className="flex flex-col gap-[1.5rem]">
        <h1 className={"pt-[2.25rem] text-3xl font-semibold"}>모임 수정하기</h1>
        <p>
