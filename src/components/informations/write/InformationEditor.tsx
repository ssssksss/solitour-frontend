...
const InformationEditor = () => {
  return (
    <form className="flex w-[60rem] flex-col">
      ...
      <div className="mt-12 flex flex-row items-center space-x-[3.375rem]">
        <select
          className="cursor-pointer text-lg font-semibold outline-none"
          name="location"
          required={true}
        >
          <option value="" disabled={true} selected={true}>
            장소 선택<span className="text-main">*</span>
          </option>
        ...
        >
          <option value="" disabled={true} selected={true}>
            카테고리 선택<span className="text-main">*</span>
          </option>
      ...
      <div className="mt-10 flex h-[3.3125rem] flex-row items-center space-x-7">
        <h2 className="text-lg font-semibold text-black">
