...
const SupportSearch = ({
  ...
  return (
    <div className="flex flex-row items-center gap-4 max-w-[21.4375rem]">
      <div className="relative z-[1] flex flex-row items-center max-[744px]:w-full">
        <input
          className="h-[2.75rem] pl-[1.125rem] rounded-full border-[0.0625rem] border-gray3 bg-white  text-sm outline-none placeholder:font-medium placeholder:text-gray2 max-[1024px]:w-full"
          type="text"
          autoComplete="search"
          placeholder="검색하기"
          value={searchValue}
