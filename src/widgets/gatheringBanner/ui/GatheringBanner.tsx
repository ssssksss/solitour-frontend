...
export const GatheringBanner = () => {
  return (
    <div className="absolute -mt-20 flex h-125 w-full flex-row items-center justify-center bg-gradient-to-br from-[#E7FCE0] to-[#C3E9FF] max-[744px]:h-[36rem]">
      <div className="flex h-96 w-240 flex-row items-center justify-between px-4 max-[1024px]:w-full max-[1024px]:px-[3.375rem] max-[744px]:mt-16 max-[744px]:flex-col max-[744px]:justify-start">
