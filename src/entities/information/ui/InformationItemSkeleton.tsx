export const InformationItemSkeleton = () => {
  return (
    <div className="outline-gray3 hover:outline-main flex h-78.75 w-full animate-pulse flex-col justify-between rounded-2xl bg-gray-100 outline duration-300 max-[744px]:min-w-[19.183125rem]">
