export const DiaryCardSkeleton = () => {
  return (
    <div className="border-gray3 hover:border-main relative aspect-3/4 w-full animate-pulse rounded-2xl border bg-gray-100 max-[744px]:aspect-auto max-[744px]:h-116">
